%% This file use for cutting and scaling video given by startFrame & endFrame
...
outputFileName = 'cutted_240fps_clip2.avi';
outputFullFileName = fullfile(pwd, outputFileName);
